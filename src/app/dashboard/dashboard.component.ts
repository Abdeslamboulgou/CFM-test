...
export class DashboardComponent implements OnInit {
  ...
  columnDefs=[
    {headerName: 'ID', field:'id', width: 195, filter: true},
    {headerName: 'Nom', field:'name', width: 195, sortable: true, filter: true},
    {headerName: 'Prénom', field:'surname', width: 195, sortable: true, filter: true},
    {headerName: 'Date Naissance', field:'birthday', width: 195, filter: true},
    {
      headerName: 'Adresses',
